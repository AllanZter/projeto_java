...
public class FormularioFuncinarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "nome", "apelido", "rg", "cpf", "email", "senha", "cargo", "nivel_acesso", "telefone", "celular", "cep", "endereco", "numero", "complemento", "bairro", "cidade", "estado"
            }
        ));
        ...
        cbCargo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vendedor", "Gerente", "Caixa", "Estoque" }));

        jLabel16.setText("Nivel de Acesso:");

        cbNivel_Acesso.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador", "Vendas", "Gerente" }));
        ...
        Dados_ClientesLayout.setHorizontalGroup(
            ...
            .addGroup(Dados_ClientesLayout.createSequentialGroup()
                ...
                .addGroup(Dados_ClientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(Dados_ClientesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(Dados_ClientesLayout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(Painel_Guias, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if(obj.getNome() != null){
            ...
            txtApelido.setText(obj.getApelido());
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        txtApelido.setText(tabela.getValueAt(tabela.getSelectedRow(),2).toString());
        ...
        cbNivel_Acesso.setSelectedItem(tabela.getValueAt(tabela.getSelectedRow(),8).toString());
        txtTelefone.setText(tabela.getValueAt(tabela.getSelectedRow(),9).toString());
        txtCelular.setText(tabela.getValueAt(tabela.getSelectedRow(),10).toString());
        txtCEP.setText(tabela.getValueAt(tabela.getSelectedRow(),11).toString());
        txtEndereco.setText(tabela.getValueAt(tabela.getSelectedRow(),12).toString());
        txtNumero.setText(tabela.getValueAt(tabela.getSelectedRow(),13).toString());
        txtComplemento.setText(tabela.getValueAt(tabela.getSelectedRow(),14).toString());
        txtBairro.setText(tabela.getValueAt(tabela.getSelectedRow(),15).toString());
        txtCidade.setText(tabela.getValueAt(tabela.getSelectedRow(),16).toString());
        cbUF.setSelectedItem(tabela.getValueAt(tabela.getSelectedRow(),17).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioFuncinarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormularioFuncinarios().setVisible(true);
            }
        });
    }
